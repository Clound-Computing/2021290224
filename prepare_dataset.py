...
#处理假新闻检测数据
# # 读取数据
# with open('data/gossipcop_v3-2_content_based_fake.json', 'r') as file:
#     data = json.load(file)
# df = pd.DataFrame(data).T
# df = df[['origin_text', 'generated_text_glm4', 'origin_label', 'has_top_img']]
# df.columns = ['original_text', 'generated_text', 'label', 'has_image']
#
# # 划分训练集和测试集
