...
#
# # 加载因果图和因果强度
# with open('data/causal_graph.pkl', 'rb') as f:
#     causal_graph = pickle.load(f)
# with open('data/causal_strength.pkl', 'rb') as f:
#     causal_strength = pickle.load(f)
#
# # 初始化并训练GCI模型
# gci = GCI()
...
#
# # 评估模型性能
# report = classification_report(test_df['label'], test_df['predictions'], target_names=['fake', 'legitimate'])
# print(report)
#
# # 保存评估报告
